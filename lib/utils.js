...
const shouldTrackEvent = (event, options) => {
    ...
    if (!storeName)
        return false;
    if ((_a = options.excludeStores) === null || _a === void 0 ? void 0 : _a.includes(storeName)) {
        return false;
    }
...
const _getObjectName = (target) => {
    ...
    if (!target)
        return null;
    try {
        if (((_a = target === null || target === void 0 ? void 0 : target.constructor) === null || _a === void 0 ? void 0 : _a.name) !== 'Object')
